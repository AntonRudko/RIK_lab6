...
- Світла та темна тема (зберігається в `localStorage`, враховує системні налаштування)
- Клавіатурні скорочення для швидкої навігації

## Клавіатурні скорочення

| Клавіша        | Дія                              |
| -------------- | -------------------------------- |
| `?`            | Відкрити / закрити підказку      |
| `C`            | Відкрити / закрити кошик         |
| `T`            | Перемкнути тему                  |
| `⌘F` / `Ctrl+F`| Сфокусуватись на пошуку          |
| `1`            | Перейти на головну               |
| `2`            | Перейти до вибраного             |
| `3`            | Перейти до замовлень             |
| `Esc`          | Закрити кошик / вікно / пошук    |
...
├── context.js              # AppContext (корзина, обране, товари)
├── ThemeContext.js          # ThemeContext + ThemeProvider
├── App.js                  # Кореневий компонент, keyboard shortcuts
├── components/
│   ├── Card/               # Картка товару
...
│   └── ShortcutsHelp/      # Модальне вікно клавіатурних скорочень
├── hooks/
│   ├── useCard.js          # Хук для роботи з корзиною
│   └── useKeyboardShortcuts.js  # Хук клавіатурних скорочень
└── pages/
